// Interface AIDL resmi Sunmi (servis printer bawaan "Woyou"), disalin dari
// implementasi upstream https://github.com/brasizza/sunmi_printer
// (paket pub.dev sunmi_printer_plus, BSD-3-Clause -- lihat LICENSE-sunmi_printer_plus
// di folder vendor/sunmi/). Package `woyou.aidlservice.jiuiv5` FIXED oleh Sunmi,
// tidak boleh diganti nama -- harus cocok dengan servis sungguhan di firmware
// perangkat. Isi/dokumentasi method aslinya berbahasa Mandarin (dipertahankan
// apa adanya dari sumbernya), lihat SunmiPrinterBridge.java untuk method mana
// saja yang benar-benar dipakai plugin ini.
